...
(function () {
  ...
  var GOL = {
    ...
    loadConfig : function() {
      ...
      var scheme = this.zoom.schemes[this.zoom.current];
      scheme.rows = Math.floor( window.innerHeight / (scheme.cellSize + 1) ) - 1;
      scheme.columns = Math.floor( window.innerWidth / (scheme.cellSize + 1) ) - 1;
    ...
    registerEvents : function() {
      ...
      //
      this.helpers.registerEvent(document.body, 'dblclick', this.handlers.buttons.run, false);
    ...
    nextStep : function() {
      ...
      // set random
      GOL.canvas.switchCell(Math.floor(Math.random() * Math.floor(200)), Math.floor(Math.random() * Math.floor(200)));
    ...
    handlers : {
      ...
      keyboard : function(e) {
        ...
        } else if (event.keyCode === 32 ) { // Key: 82 - R
